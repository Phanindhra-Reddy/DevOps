...
import (
	...
	apiv1alpha1 "github.com/phani953/scalar-operator/api/v1alpha1"
)
...
//+kubebuilder:rbac:groups=api.phanindhra.reddy,resources=scalars,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=api.phanindhra.reddy,resources=scalars/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=api.phanindhra.reddy,resources=scalars/finalizers,verbs=update
